...
def get_types_data():
    ...
    return [{"type": type_info["name"]} for type_info in types]
...
def save_types_to_json(types_data):
    ...
    file_path = os.path.join(data_directory, "data_types_consumer.json")
...
if __name__ == "__main__":
    print("Obteniendo datos de los tipos de los Pokémon...")
